...
module Typograph
  class Processor
    ...
    def typo_text(str)
      ...
      # Предлоги и союзы
      prepos = 'а|в|во|вне|и|или|к|о|с|у|о|со|об|обо|от|ото|то|на|не|ни|но|из|изо|за|уж|на|по|под|подо|пред|предо|про|над|надо|как|без|безо|что|да|для|до|там|ещё|их|или|ко|меж|между|перед|передо|около|через|сквозь|при|я'
      ...
      rules_strict = {
        ...
        /(стр|с|табл|рис|илл|гл)\.\s*(\d+)/i => '\1.' + sym['nbsp'] + '\2',
        ...
        /([А-ЯA-Z]\.)\s?([А-ЯA-Z]\.)\s?([А-Яа-яA-Za-z]+)/ => '\1\2' + sym['nbsp'] + '\3',
